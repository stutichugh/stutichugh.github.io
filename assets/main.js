  ...
  $('.js-form').submit(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        showModal('Comment submitted', 'Thanks! Your comment is <a href="https://github.com/stutichugh/stutichugh.github.io/pulls">pending</a>. It will appear when approved.');
